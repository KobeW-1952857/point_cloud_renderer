...
__global__ void OctreeKernel(glm::dvec3* points, glm::dvec3* pointsExch, Octree* tree, int depth, int maxDepth, int minPointsToDivide)
{
             ...
             i += thisWarp.size())
    {
        ...
        const auto point = isInRange ? pointsExch[i] : glm::dvec3{};
